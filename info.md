...
- **📅 Holiday Diagnostics**: `sensor.tnb_cached_holidays_count` now lists every cached holiday and the last fetch timestamp in its attributes for easy verification.
